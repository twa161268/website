...
router.post('/', requireLogin, upload.array('gambar', 50), c.create);
...
router.post(
  '/edit/:id',
  requireLogin,
  upload.array('gambar_baru', 50),
  c.update
);

router.post('/gambar/delete/:id', requireLogin, c.deleteImage);

router.delete('/gambar/delete/:id', requireLogin, c.deleteImage);
